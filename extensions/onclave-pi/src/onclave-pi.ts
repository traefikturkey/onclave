...
const INSTANCES_PROMPT_GUIDELINES = [
  ...
  "Do not use onclave_instances to find substitutes for Pi subagents, reviewers, failed delegation, provider failures, or workload distribution.",
] as const;
const MESSAGE_PROMPT_GUIDELINES = [
  ...
  "Do not use onclave_message as a substitute for subagent_read, subagent_write, subagent_teamlead, review delegation, provider fallback, or failed local execution.",
