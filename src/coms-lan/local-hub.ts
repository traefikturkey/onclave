...
export async function readHubState(paths: ComsLanPaths): Promise<HubState | null> {
  try {
...
export async function writeHubState(paths: ComsLanPaths, state: HubState): Promise<void> {
