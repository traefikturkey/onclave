...
```bash
pi --no-extensions -e ./extensions/onclave-pi
```
...
| Flag | Meaning |
| --- | --- |
| `-e`, `--extension <source>` | Load `extensions/onclave-pi` directly |
...
```bash
pi --no-extensions -e ./extensions/onclave-pi --explicit
```
...
```bash
pi -e ./extensions/onclave-pi --name local-a
```
...
```bash
pi -e ./extensions/onclave-pi --name local-b
```
...
```bash
pi -e ./extensions/onclave-pi --name host-b
```
...
```bash
pi --no-extensions -e ./extensions/onclave-pi --name host-a
```
